...
// > node ./test/populatedb "mongodb://mongoadmin:mongoinst1@fourmi-t01-shard-00-00-nibln.mongodb.net:27017,fourmi-t01-shard-00-01-nibln.mongodb.net:27017,fourmi-t01-shard-00-02-nibln.mongodb.net:27017/local_library?ssl=true&replicaSet=FOURMI-T01-shard-0&authSource=admin"
...
console.log('userArgs: ' + JSON.stringify(userArgs));
...
// clear all previous data in the target database
function clearPreviousData(cb) {
  async.parallel([
    function (callback) {
    ...
    function (callback) {
      BookInstance.remove({}, function (err) {
        ...
        console.log('Removed all BookInstances.');
        callback(null, null);
      });
    },
    function (callback) {
